...
class GrupoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppBundle:Grupo')->findAll();
     ...
     * @Method("POST")
     * @Template("AppBundle:Grupo:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppBundle:Grupo')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AppBundle:Grupo:edit.html.twig")
     */
     ...
     *
     * @Route("/{id}/eliminar", name="grupo_delete")
     */
